...
import { genders, talents } from 'src/dropdownItems'

import useAxios from 'src/hooks/useAxios'
import {
  CREATE_CONTESTANT_API_URL,
  GET_BARANGAY_API_URL,
  GET_CITY_API_URL,
  GET_PROFILE_API_URL,
  GET_PROVINCE_API_URL,
  GET_REGION_API_URL,
} from 'src/config/apiRoutes'
...
const Edit = () => {
  ...
  const detailsQuery = useQuery({
    ...
    queryFn: () => get(GET_PROFILE_API_URL),
